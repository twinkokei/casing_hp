...
<body margin-left="0" margin-top="0">
 <div class="header_fixed">
  ...
  <div class="border_meja" style="display:none">
    <img src="../img/building/<?= $building_img ?>"/>
  </div>
 <?php
...
<div id="content_new">
   <?php
	...
	?>
	<span class="tooltip tooltip-effect-1  hide-on-mobile">
  	<div id="makeMeDraggable_<?= $row['table_id']?>" <?php if($row['tms_id']==1){ ?>class="meja2" <?php  }else{ ?>class="meja1"<?php } ?>>
                  ...
                  <div class="count_item_ordered"><?= $get_item_not_ordered ?></div>
                  <?php
  				}
  				?>
                  <?php
...
//                                echo '<pre>';
//                                echo "waktu saiki $now_res";
//                                echo "waktu wingi $res_time";
//                                echo '</pre>';
//                                exit();
  				?>
  				<div class="table_reserved">
                                    <?php if($now_res >= $res_time){ ?>
      ...
      <div class="show-on-mobile">
          ...
          <?
            ...
            while($row = mysql_fetch_array($query)) {
              $get_item_ordered = get_item_ordered($row['table_id']);
              $get_item_not_ordered = get_item_not_ordered($row['table_id']); ?>
              <h3 class="accordion-header text-center">Meja <?= $row['table_name']?>
                <?
                if($row['table_status_id'] == 2){?>
                  <!-- <div class="count_item_ordered"><?= $get_item_ordered ?></div> -->
                  <div class="count_item_ordered"><?= $get_item_not_ordered ?></div>
