	...
	<span class="tooltip-text">
		...
		<div class="row">
			...
			<div class="col-xs-4 hide-on-mobile" style="padding:3px;">
				<form action="order.php?page=add_duration&reserved_id=<?= $row_res['reserved_id']?>&building_id=<?= $building_id?>" enctype="multipart/form-data" method="post">
					...
					<input type="submit" name="button" id="button" value="ADD DURATION" class="btn_add_order"/>
				</form>
			</div>
			<div class="col-xs-4 hide-on-mobile" style="padding:3px;">
	...
	<div class="col-md-4 show-on-mobile">
		<div class="form-group">
			<div class="col-md-4" style="padding:3px; "><a href="transaction_new.php?table_id=<?= $row['table_id']?>" style="text-decoration:none;"><div class="btn_add_order" style="height:70px; padding-top:20px;">PROCESS RESERVED</div></a>
		</div>
		<div class="col-md-4" style="padding:5px;">
			<form action="order.php?page=add_duration&reserved_id=<?= $row_res['reserved_id']?>&building_id=<?= $building_id?>" enctype="multipart/form-data" method="post">
				<select class="form-control" name="i_duration" style="heigt:25px;">
					<option value="15">15 Menit</option>
					<option value="30">30 Menit</option>
					<option value="60">1 Jam</option>
				</select>
