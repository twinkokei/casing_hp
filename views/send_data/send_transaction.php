...
<html>
  ...
  <body>
    ...
    <form id="trans_tc">
      <div class="">
        <input type="" id="transaction_code" name="transaction_code" value="<?= $transaction_code?>">
        <input type="" id="branch_id" name="branch_id" value="<?= $branch_id?>">
        <input type="" id="transaction_date" name="transaction_date" value="<?= $transaction_date?>">
        <input type="" id="jumlah" name="jumlah" value="1">
      </div>
    </form>
