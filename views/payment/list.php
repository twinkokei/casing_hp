...
<body class="skin-blue">
 <div class="header_fixed">
    <div class="morph-button morph-button-modal morph-button-modal-3 morph-button-fixed">
      <button class="blue_color_button hide-on-mobile"  type="button"  onClick="javascript: window.location.href = '<?= $button_back?>'; ">BACK TO ORDER</button>
    </div><!-- morph-button -->
    <div class="logo_order hide-on-mobile"></div>
    <div class="logo_order Show-on-mobile" type="button"  onClick="javascript: window.location.href = '<?= $button_back?>';"></div>
 </div>
  <br>
  <br>
                                    ...
                                    <div class="payment_group" id="bank_frame" style="display:none; width:100%;">
                                     <b> Bank</b>
                                      ...
                                      <div class="col-md-6" style="padding-left:0px; ">
                                       ...
                                       <div class="col-md-6" style="padding-left:0px; ">
                                          <input type="text" name="i_bank_account" id="i_bank_account" class="form-control" value="" placeholder="No Kartu"
                              ...
                              <div class="col-md-12" style="padding:0px;">
                                <div class="payment_group">
                                  <div class="calc_title">
                                    ...
                                    <input min="0" required type="text" name="i_payment" id="i_payment" class="form-control calc_nominal" value="<?= ($totalkedua) ?>" style="text-align:right;" onChange="update_change()"/>
                                  ...
                                  <div style="border-bottom:1px #000 dotted; padding-bottom:5px; margin-bottom:5px;"></div>
                                    <table width="100%">
                                     <tfoot>
                                        ...
                                        <!-- <tr>
                                          <td colspan="5">
                                            <a href="print_bill.php?table_id=<?=$table_id?>$building_id=<?=$building_id?>" target="_blank" class="btn button_save_payment btn-block">
                                              <i class="fa fa-print"></i>Print Bill</a>
                                            </td>
                                        </tr> -->
                                    </tfoot>
                                  </table>
