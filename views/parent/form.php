                              ...
                              <div class="box-body">
                                  <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input required type="text" name="i_name" class="form-control" placeholder="Enter name ..." value="<?= $row->side_menu_name ?>"/>
                                    </div>
                                      <div class="form-group">
                                        <label>Phone</label>
                                        ...
                                        <input required class="form-control" type="text" name="i_phone" placeholder="Enter phone ..." value="<?= $row->side_menu_url?>">
                                        </div>
                                      </div>
                                        <div class="form-group">
                                          <label>Type</label>
                                           ...
                                           while($r_type = mysql_fetch_array($query_type)){
                                            ?>
                                             <option value="<?= $r_type['side_menu_id'] ?>" <?php if($row->side_menu_id == $r_type['side_menu_id']){ ?> selected="selected"<?php } ?>><?= $r_type['side_menu_url']?></option>
                                             <?php
                                             }
                                             ?>
                                           </select>
                                          ...
                                          <div class="form-group">
                                              <label>Branch</label>
                                               ...
                                               while($r_branch = mysql_fetch_array($query_branch)){
                                                ?>
                                                 <option value="<?= $r_branch['side_menu_id'] ?>" <?php if($row->branch_id == $r_branch['branch_id']){ ?> selected="selected"<?php } ?>><?= $r_branch['branch_name']?></option>
                                                 <?php
                                                 }
                                                 ?>
                                               </select>
