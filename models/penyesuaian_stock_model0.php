...
function select($where){
  $query = mysql_query("SELECT a.*, b.*, c.item_type_name,d.item_price, e.branch_name FROM item_stocks a
...
function read_id($id,$branch_id){
  $query = mysql_query("SELECT a.*, b.*, c.item_type_name, d.kategori_buku_name, e.branch_name FROM item_stocks a
